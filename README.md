push data from json file into an array and then loop over the array to populate the DOM.  when songs are added to the form, then push those songs to the array as well.
